    ...
    constructor(functionHandler, minifyManager) {
        ...
        this.availableFunctions = {
            reponse_dictionnaire: {
                handler: (args) => {
                    // Exemple de traitement des données reçues
                    const haut = args.haut || {}
                    const bas = args.bas || {}

                    const result = {
                        success: true,
                        message: `Réponse traitée avec ${
                            Object.keys(haut).length
                        } articles pour le haut et ${
                            Object.keys(bas).length
                        } articles pour le bas.`,
                    }
                ...
                description:
                    "Traite une réponse structurée avec des articles pour le haut et le bas.",
                parameters: {
                    haut: {
                        type: "object",
                        description:
                            "Articles pour le haut, avec nom, marque, prix et couleur.",
                    },
                    bas: {
                        type: "object",
                        description:
                            "Articles pour le bas, avec nom, marque, prix et couleur.",
                    },
                },
            },
