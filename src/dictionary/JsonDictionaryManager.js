...
2. Tu dois choisir les mots qui répondent le plus précisément à la question.
3. Réponds avec UNIQUEMENT l'objet JSON brut, sans aucun autre texte avant ou après.
4. Les mots dans le tableau doivent être dans un ordre logique pour former une réponse cohérente.
5. NE PAS mettre le JSON dans des blocs de code avec des backticks (\`\`\`).
6. NE PAS ajouter de formatage markdown.
7. Renvoie UNIQUEMENT le JSON pur.
8. Choisis la fonction la plus appropriée pour répondre à la demande de l'utilisateur.
