    ...
    addMessageToChat(sender, message) {
        ...
        if (sender === "assistant") {
            try {
                ...
                // Extraire les informations de l'ensemble
                const { ensemble, prix_total } = jsonResponse
                const {
                    nom,
                    description,
                    couleur,
                ...
                contentElement.innerHTML = `
                    <div style="border-left: 4px solid ${couleur}; padding-left: 10px;">
                        ...
                        <ul>
                            ${
                                chapeau
                                    ? `<li><strong>Chapeau :</strong> ${
                                          Object.keys(chapeau)[0]
                                      }</li>`
                                    : ""
                            }
                            ${
                                haut
                                    ? `<li><strong>Haut :</strong> ${Object.keys(
                                          haut
                                      ).join(", ")}</li>`
                                    : ""
                            }
                            ...
                            ${
                                chaussure
                                    ? `<li><strong>Chaussure :</strong> ${
                                          Object.keys(chaussure)[0]
                                      }</li>`
                                    : ""
                            }
                        </ul>
